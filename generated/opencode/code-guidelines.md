...
5. **Write** — render the survivors into `.code-guidelines/project-conventions.md` using the fixed template at `~/.code-guidelines/distill/template.md`: guardrails phrasing (negative constraints, not general advice), at most 80 lines total.
