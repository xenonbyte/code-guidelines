...
r2p_version: 2
r2p_status: approved
r2p_created_at: 2026-07-04T05:43:36.150257+00:00
r2p_updated_at: 2026-07-04T05:46:35.521856+00:00
---
...
- R6 谓词接入：`pythonDeps` 并入 base-OR（与 files/packageDeps/extensions 平级）；同步更新 sync.mjs 的 `SPEC-DETECT-001` [N/A] 注释块（此 ID 为 `assets/sync.mjs` 内既有源码注释块的锚点标识，非 r2p 上游阶段产物引用，不纳入闭合追踪；R6 会照常更新该注释块正文）。
