...
work_id: WF-20260703-status-active-slug-code-guidelines
requirement: ---
status: active
...
## Evidence Block
keywords_hit: ['rust', 'go', 'typescript', 'javascript', 'python', 'java', 'kotlin', 'swift', 'c', 'ruby', 'php', 'react', 'vue', 'angular', 'svelte', 'next.js', 'nuxt', 'astro', 'express', 'fastify', 'django', 'flask', 'fastapi', 'rails', 'spring', 'laravel', 'mongodb', '.net', 'monorepo', '项目', '仓库', 'project', 'monorepo', '删除', '清理', '清除', '调用', '依赖', 'third-party', '全部', '所有', '全套']
