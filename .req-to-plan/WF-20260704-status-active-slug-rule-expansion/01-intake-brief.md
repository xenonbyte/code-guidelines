...
work_id: WF-20260704-status-active-slug-rule-expansion
requirement: ---
status: active
...
## Evidence Block
keywords_hit: ['替换', 'python', 'kotlin', 'swift', 'c', 'react', 'vue', 'angular', 'svelte', 'solid', 'qwik', 'next.js', 'nextjs', 'nuxt', 'astro', 'nestjs', 'django', 'flask', 'fastapi', 'mongodb', 'redis', 'dotnet', 'monorepo', 'serverless', '仓库', 'project', 'repo', 'monorepo', '删除', '截断', 'token', 'token', '接入', '依赖', 'sdk', 'mcp', 'third-party', 'sdk', 'mcp', '全部']
repo_baseline_summary: loc=48, modules=3, monorepo=True, languages=['JavaScript', 'PHP']
linked_context: none
scope_signals: ['全部']
